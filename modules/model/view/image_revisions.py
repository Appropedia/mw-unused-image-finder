...
#Get summarized information about an specific image
def get_image_summary(image_title: int) -> tuple[int, str, int, int, int] |\
...
#Get information about an specific revision
